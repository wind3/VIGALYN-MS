...
public class TopicRabbitConfiguration {
	...
	public static final String TOPIC_ROUTING_KEY_VIGALYN = "TOPIC.VIGALYN";
	...
	@Bean("vigalyn")
	public Queue vigalyn() {
	    return new Queue(TOPIC_ROUTING_KEY_VIGALYN);
	}
	...
	@Bean
	public Binding bindingExchangeToQueue(Queue vigalyn,TopicExchange topicExchange) {
	    return BindingBuilder.bind(vigalyn).to(topicExchange).with("TOPIC.#");
	}
