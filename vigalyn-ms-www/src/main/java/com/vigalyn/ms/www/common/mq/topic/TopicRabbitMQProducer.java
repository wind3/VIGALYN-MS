...
public class TopicRabbitMQProducer {
	...
	public void sendToVigalyn() {
	    String context = TopicRabbitConfiguration.TOPIC_ROUTING_KEY_VIGALYN + "\t";
	    this.rabbitTemplate.convertAndSend(TopicRabbitConfiguration.TOPIC_EXCHANGE, TopicRabbitConfiguration.TOPIC_ROUTING_KEY_VIGALYN, context);
	}
}