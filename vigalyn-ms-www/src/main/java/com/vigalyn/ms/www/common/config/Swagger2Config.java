...
public class Swagger2Config {
    ...
    // TODO http://localhost:port/swagger-ui.html
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                   ...
                   .apis(RequestHandlerSelectors.basePackage("com.vigalyn.ms.www"))
                   .paths(PathSelectors.any())
                   .build();
    }
    
    private ApiInfo apiInfo() {
        Contact contact = new Contact("zengwj", "http://www.vigalyn.com", "wind3at048@126.com");
        return new ApiInfoBuilder()
                   .title("Spring Boot中使用Swagger2构建RESTful APIs")
                   .description("更多Spring Boot相关实践请关注：https://github.com/wind3/VIGALYN-CONFIG.git")
                   .termsOfServiceUrl("https://github.com/wind3/VIGALYN-CONFIG/tree/master/vigalyn-ms-www/")
                   .contact(contact)
